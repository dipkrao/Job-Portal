                        ...
                        children: <Widget>[
                          Expanded(
                            child: ElevatedButton.icon(
                              onPressed: () => controller.chooseRecruiter(true),
                              icon: Icon(
                                Icons.person_search_outlined,
                                color: controller.isRecruiter
                                    ? Colors.white
                                    : Color(0xFF42AFFF),
                              ),
                              label: Text(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor: controller.isRecruiter
                                    ? Color(0xFF42AFFF)
                                    : Colors.white,
                              ),
                            ),
                          ...
                          Expanded(
                              child: ElevatedButton.icon(
                            onPressed: () => controller.chooseRecruiter(false),
                            style: ElevatedButton.styleFrom(
                              backgroundColor: !controller.isRecruiter
                                  ? Color(0xFF42AFFF)
                                  : Colors.white,
                          ...
                          children: [
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(
                                isDense: true,
                                contentPadding:
                                    EdgeInsets.fromLTRB(10, 12, 0, 12),
                                border: OutlineInputBorder(),
